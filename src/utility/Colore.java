package utility;
public class Colore {
    public static final String RESET = "\033[0m";  // Da inserire a ogni fine colorazione

    public static final String ERASE = "\033[H\033[2J";
    
    public static final String HIDDEN = "\033[8;30m";
    
    //Crea un box intorno alla stringa
    public static final String BOXING = "\033[0;51m";   // BLACK

    //Crea un background nero con scritta bianca sopra
